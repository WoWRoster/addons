...
class rostergalleryinstall
{
	...
	function install()
	{
		...
		$installer->add_config("1,'startpage','display','display','master'");
            ...
            'config_cat1' => '0','config_cat2' => '0',
            'config_cat3' => '0','config_cat4' => '0',
            'config_cat5' => '0','config_cat6' => '0',
            'config_cat7' => '0','config_cat8' => '0',
            'config_cat9' => '0','config_cat10' => '0',
	...
	function upgrade($oldversion)
	{
		...
		$upgradess = array('config_cat1' => '0','config_cat2' => '0',
            'config_cat3' => '0','config_cat4' => '0',
            'config_cat5' => '0','config_cat6' => '0',
            'config_cat7' => '0','config_cat8' => '0',
            'config_cat9' => '0','config_cat10' => '0');
            ...
            //rg_version
            $installer->add_query("UPDATE `" . $installer->table('ss') . "` SET `rg_version` = '3.0.3999';");
