...
define('MADEBY_VERSION', 'MadeBy v1.7.3 beta 5');
...
// v1.7.2.7 -- new sort option text
$wordings['enUS']['admin']['default_sort_by']	=	'Default Sort|Select recipes default sort method.';
// v1.7.3 -- new multilang support; select languages to support
$wordings['enUS']['admin']['multi_lang_use']	=	'Select Languages|Select Languages you want to support.';
$wordings['enUS']['admin']['display_language_bar']	=	'Multi-Language Bar|Shows the language bar and allows default language to change while using MadeBy.';
$wordings['enUS']['admin']['allow_enUS']	= 'Show Language enUS|Show Language enUS';
$wordings['enUS']['admin']['allow_deDE']	= 'Show Language deDE|Show Language deDE';
$wordings['enUS']['admin']['allow_frFR']	= 'Show Language frFR|Show Language frFR';
$wordings['enUS']['admin']['allow_esES']	= 'Show Language esES|Show Language esES';
...
// v1.7.2.6 -- jewelcrafting support
...
// v1.7.2.7 -- new sort option text
$wordings['deDE']['admin']['default_sort_by']	=	'Default Sort|Select recipes default sort method.';
// v1.7.3 -- new multilang support; select languages to support
$wordings['deDE']['admin']['multi_lang_use']	=	'Select Languages|Select Languages you want to support.';
$wordings['deDE']['admin']['display_language_bar']	=	'Multi-Language Bar|Shows the language bar and allows default language to change while using MadeBy.';
$wordings['deDE']['admin']['allow_enUS']	= 'Show Language enUS|Show Language enUS';
$wordings['deDE']['admin']['allow_deDE']	= 'Show Language deDE|Show Language deDE';
$wordings['deDE']['admin']['allow_frFR']	= 'Show Language frFR|Show Language frFR';
$wordings['deDE']['admin']['allow_esES']	= 'Show Language esES|Show Language esES';

// recipe config
$wordings['deDE']['admin']['Blacksmithing'] = 'Schmiedekunst|MÃ¶chtest du es erlauben, dass Schmiedekunst angezeigt wird?';
$wordings['deDE']['admin']['Mining'] = 'Bergbau|MÃ¶chtest du es erlauben, dass Bergbau angezeigt wird?';
$wordings['deDE']['admin']['Alchemy'] = 'Alchimie|MÃ¶chtest du es erlauben, dass Alchimie angezeigt wird?';
$wordings['deDE']['admin']['Leatherworking'] = 'Lederverarbeitung|MÃ¶chtest du es erlauben, dass Lederverarbeitung angezeigt wird?';
$wordings['deDE']['admin']['Tailoring'] = 'Schneiderei|MÃ¶chtest du es erlauben, dass Schneiderei angezeigt wird?';
$wordings['deDE']['admin']['Enchanting'] = 'Verzauberkunst|MÃ¶chtest du es erlauben, dass Verzauberkunst angezeigt wird?';
$wordings['deDE']['admin']['Engineering'] = 'Ingenieurskunst|MÃ¶chtest du es erlauben, dass Ingenieurskunst angezeigt wird?';
$wordings['deDE']['admin']['Cooking'] = 'Kochkunst|MÃ¶chtest du es erlauben, dass Kochkunst angezeigt wird?';
$wordings['deDE']['admin']['First Aid'] = 'Erste Hilfe|MÃ¶chtest du es erlauben, dass Erste Hilfe angezeigt wird?';
$wordings['deDE']['admin']['Poisons'] = 'Gifte|MÃ¶chtest du es erlauben, dass Gifte angezeigt wird?';
// 1.7.2.6 -- jewelcrafting support
$wordings['deDE']['admin']['Jewelcrafting'] = 'Juwelenschleifen|Do you wish to allow JewelCrafting to be shown?';
...
// v1.7.2.7 -- new sort option text
$wordings['frFR']['admin']['default_sort_by']	=	'Default Sort|Select recipes default sort method.';
// v1.7.3 -- new multilang support; select languages to support
$wordings['frFR']['admin']['multi_lang_use']	=	'Select Languages|Select Languages you want to support.';
$wordings['frFR']['admin']['display_language_bar']	=	'Multi-Language Bar|Shows the language bar and allows default language to change while using MadeBy.';
$wordings['frFR']['admin']['allow_enUS']	= 'Show Language enUS|Show Language enUS';
$wordings['frFR']['admin']['allow_deDE']	= 'Show Language deDE|Show Language deDE';
$wordings['frFR']['admin']['allow_frFR']	= 'Show Language frFR|Show Language frFR';
$wordings['frFR']['admin']['allow_esES']	= 'Show Language esES|Show Language esES';

// recipe config
$wordings['frFR']['admin']['Blacksmithing'] = 'Forge|Voulez vous autoriser la Forge à être affichée ?';
$wordings['frFR']['admin']['Mining'] = 'Minage|Voulez vous autoriser le Minage à être affiché ?';
$wordings['frFR']['admin']['Alchemy'] = 'Alchimie|Voulez vous autoriser l\'Alchimie à être affichée ?';
$wordings['frFR']['admin']['Leatherworking'] = 'Travail du cuir|Voulez vous autoriser le Travail du cuir à être affiché ?';
$wordings['frFR']['admin']['Tailoring'] = 'Couture|Voulez vous autoriser la Couture à être affichée ?';
$wordings['frFR']['admin']['Enchanting'] = 'Enchantement|Voulez vous autoriser l\'Enchantement à être affiché ?';
$wordings['frFR']['admin']['Engineering'] = 'Ingénierie|Voulez vous autoriser l\'Ingénierie à être affichée ?';
$wordings['frFR']['admin']['Cooking'] = 'Cuisine|Voulez vous autoriser la Cuisine à être affichée ?';
$wordings['frFR']['admin']['First Aid'] = 'Secourisme|Voulez vous autoriser le Secourisme à être affiché ?';
$wordings['frFR']['admin']['Poisons'] = 'Poisons|Voulez vous autoriser les Poisons à être affichés ?';
// 1.7.2.6 -- jewelcrafting support
$wordings['frFR']['admin']['Jewelcrafting'] = 'Joaillerie|Voulez vous autoriser la Joaillerie à être affichée ?';
...
// v1.7.2.7 -- new sort option text
$wordings['esES']['admin']['default_sort_by']	=	'Default Sort|Select recipes default sort method.';
// v1.7.3 -- new multilang support; select languages to support
$wordings['esES']['admin']['multi_lang_use']	=	'Select Languages|Select Languages you want to support.';
$wordings['esES']['admin']['display_language_bar']	=	'Multi-Language Bar|Shows the language bar and allows default language to change while using MadeBy.';
$wordings['esES']['admin']['allow_enUS']	= 'Show Language enUS|Show Language enUS';
$wordings['esES']['admin']['allow_deDE']	= 'Show Language deDE|Show Language deDE';
$wordings['esES']['admin']['allow_frFR']	= 'Show Language frFR|Show Language frFR';
$wordings['esES']['admin']['allow_esES']	= 'Show Language esES|Show Language esES';

// recipe config
$wordings['esES']['admin']['Blacksmithing'] = 'Herrería|¿Deseas mostrar Herrería?';
$wordings['esES']['admin']['Mining'] = 'Minería|¿Deseas mostrar Minería?';
$wordings['esES']['admin']['Alchemy'] = 'Alquimia|¿Deseas mostrar Alquimia?';
$wordings['esES']['admin']['Leatherworking'] = 'Peletería|¿Deseas mostrar Peletería?';
$wordings['esES']['admin']['Tailoring'] = 'Sastrería|¿Deseas mostrar Sastrería?';
$wordings['esES']['admin']['Enchanting'] = 'Encantamiento|¿Deseas mostrar Encantamiento?';
$wordings['esES']['admin']['Engineering'] = 'Ingeniería|¿Deseas mostrar Ingeniería?';
$wordings['esES']['admin']['Cooking'] = 'Cocina|¿Deseas mostrar Cocina?';
$wordings['esES']['admin']['First Aid'] = 'Primeros Auxilios|¿Deseas mostrar Primeros Auxilios?';
$wordings['esES']['admin']['Poisons'] = 'Venenos|¿Deseas mostrar Venenos?';
// 1.7.2.6 -- jewelcrafting support
$wordings['esES']['admin']['Jewelcrafting'] = 'JewelCrafting|Do you wish to allow JewelCrafting to be shown?';
