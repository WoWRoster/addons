...
$wordings[$roster_conf['roster_lang']]['MadeBy_installed_msg'].'<br />'.make_link('', $wordings[$roster_conf['roster_lang']]['MadeBy_Configure_txt'], array('action'=>'config')).
border('sgreen','end');
