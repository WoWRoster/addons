...
echo border('sgreen','start',$wordings[$roster_conf['roster_lang']]['Skeleton_install_page']).
	$wordings[$roster_conf['roster_lang']]['Skeleton_installed'].'<br />'.
	"<a href='?roster_addon_name=AltMonitor&action=config'>".$wordings[$roster_conf['roster_lang']]['Skeleton_config']."</a>".
	border('sgreen','end');
