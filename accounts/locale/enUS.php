...
// Button names 
$lang['acc_index']        		= 'My Account|Displays your characters, guilds, and realms.';
$lang['acc_register_bttn']		= 'Register|Displays the account registration page.';
$lang['acc_characters']			= 'My Characters|Displays your characters.';
$lang['acc_guilds']				= 'My Guilds|Displays your guilds.';
$lang['acc_realms']				= 'My Realms|Displays your realms.';
$lang['acc_settings']			= 'Settings|Displays the user settings.';

// Interface wordings
$lang['acc_register']			= 'Register';
$lang['acc_no_register']		= 'Not registered yet?';
$lang['acc_uname']				= 'User Name';
$lang['acc_fname']				= 'First Name';
$lang['acc_lname']				= 'Last Name';
$lang['acc_email']				= 'E-Mail';
$lang['acc_group']				= 'Group Password';
$lang['acc_login_txt']			= 'Please enter your username and password.';
$lang['acc_no_login']			= 'You must be logged in to view this page.';
$lang['acc_reg_txt']			= 'Please fill in the following fields (fields with * are required).';
$lang['acc_act_pass_txt']		= 'Enter your new password here, ';
$lang['acc_no_access_txt']		= 'You are not allowed to view this page!';
$lang['acc_main_page']			= 'Accounts Main Page';
$lang['acc_forgot']				= 'Forgot your username/password?';
$lang['acc_forgot_txt']			= 'Please enter the e-mail address that you used during registration.';
...
// Page names 
$lang['acc_main_page']			= 'Accounts Main';
$lang['acc_user_admin']			= 'User Admin';
$lang['acc_no_access']			= 'Access Denied!';
$lang['acc_reg_page']			= 'Accounts Registration';
$lang['acc_reg_app']			= 'User Application';
$lang['acc_reg_user']			= 'User Registration';
$lang['acc_act_user']			= 'User Activation';
$lang['acc_act_pass']			= 'Password Activation';
$lang['acc_settings_page']		= 'My Settings';
$lang['acc_realms_page']		= 'My Realms';
$lang['acc_guilds_page']		= 'My Guilds';
$lang['acc_chars_page']			= 'My Characters';
...
$lang['acc_user']['msg11']			= "Username and/or password is empty!";
$lang['acc_user']['msg12']			= "Sorry, a user with this login and/or e-mail address already exist.";
$lang['acc_user']['msg13']			= "Please check your e-mail and follow the instructions.";
$lang['acc_user']['msg14']			= "Sorry, an error occurred please try again.";
$lang['acc_user']['msg15']			= "Sorry, an error occurred please try again later.";
$lang['acc_user']['msg16']			= "The e-mail address is not valid.";
$lang['acc_user']['msg17']			= "The field login (min. %d char.) is required.";
$lang['acc_user']['msg18']			= "Your request has been processed. Login to continue.";
$lang['acc_user']['msg19']			= "Sorry, cannot activate your account.";
$lang['acc_user']['msg20']			= "There is no account to activate.";
$lang['acc_user']['msg21']			= "Sorry, this activation key is not valid!";
$lang['acc_user']['msg22']			= "Sorry, there is no active account that matches with this e-mail address.";
$lang['acc_user']['msg23']			= "Please check your e-mail to get your new password.";
$lang['acc_user']['msg25']			= "Sorry, cannot activate your password.";
$lang['acc_user']['msg26']			= "New user request...";
$lang['acc_user']['msg27']			= "Please check your e-mail and activate your modification(s).";
$lang['acc_user']['msg28']			= "Your request must be processed...";
$lang['acc_user']['msg29']			= "Hello %s,\r\n\r\nto activate your request click the following link:\r\n%s&uid=%d&act_key=%s";
$lang['acc_user']['msg30']			= "Your account is modified.";
$lang['acc_user']['msg31']			= "This e-mail address already exists, please use another one.";
$lang['acc_user']['msg32']			= "The field password (min. %d char) is required.";
$lang['acc_user']['msg33']			= "Hello %s,\r\n\r\nthe new e-mail address must be validated, click the following link:\r\n%s&uid=%d&validate=%s";
$lang['acc_user']['msg34']			= "There is no e-mail address for validation.";
$lang['acc_user']['msg35']			= "Hello %s,\r\n\r\nEnter your new password next, please click the following link to enter the form:\r\n%s&uid=%d&act_key=%s";
$lang['acc_user']['msg36']			= "Your request has been processed and is pending validation by the admin. \r\nYou will get an e-mail if it's done.";
$lang['acc_user']['msg37']			= "Hello %s,\r\n\r\nThe account is active and it's possible to login now.\r\n\r\nClick on this link to access the login page:\r\n%s\r\n\r\nkind regards\r\n%s";
$lang['acc_user']['msg38']			= "The confirmation password does not match the password. Please try again.";
$lang['acc_user']['msg39']			= "New user registration on %s:\r\n\r\nClick here to enter the admin page:\r\n\r\n%s";

// Profile class messages
$lang['acc_profile']['msg1']		= "There is no profile data at the moment.";
$lang['acc_profile']['msg2']		= "Your profile data is up to date.";
$lang['acc_profile']['msg3']		= "There was an error during update, please try again.";
