...
$className = "Warlock Talents - Wrath of the Lich King Beta Talents";
...
$talent[$i] = array(0, "Frailty", 2, 1, 2); $i++;
...
$talent[$i] = array(0, "Pandemic", 3, 3, 9); $i++;
...
$talent[$i] = array(1, "Demonic Sacrifice", 1, 1, 5); $i++;
$talent[$i] = array(1, "Master Conjuror", 2, 3, 5); $i++;
$talent[$i] = array(1, "Mana Feed", 3, 1, 6); $i++;
$talent[$i] = array(1, "Master Demonologist", 5, 2, 6); $i++;
$talent[$i] = array(1, "Improved Enslave Demon", 2, 3, 6); $i++;
...
$talent[$i] = array(2, "Molten Core", 3, 2, 2); $i++;
...
$talent[$i] = array(2, "Pyroclasm", 2, 1, 5); $i++;
...
$talent[$i] = array(2, "Backlash", 3, 4, 7); $i++; 
...
$rank[$i] = array(
		...
		&nbsp;Rank 5: 350 Mana, 52 Health<br>\
		&nbsp;Rank 6: 410 Mana, 63 Health<br>\
		&nbsp;Rank 7: 605 Mana, 70 Health<br>\
...
$rank[$i] = array(
		"<span style=text-align:left;float:left;>231 Mana</span><span style=text-align:right;float:right;>30 yd range</span><br>Instant cast<br>Reduces the target\'s movement speed by 50% for 12 sec. Only one Curse per Warlock can be active on any one target."
		);		
$i++;		
...
//Haunt - Affliction 
$rank[$i] = array(
"<span style=text-align:left;float:left;>462 Mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>1.5 sec cast</span><span style=text-align:right;float:right;>8 sec cooldown</span><br> You send a ghostly soul into the target, dealing 445 to 521 Shadow damage and increasing all damage done by your damage-over-time effects on the target by 20% for 12 sec. When the Haunt spell ends or is dispelled, the soul returns to you, healing you for 100% of all damage done to the target."
		);
$i++;		
...
$rank[$i]= array(
		"<span style=text-align:left;float:left;>616 Mana</span><span style=text-align:right;float:right;>100 yd range</span><br>Instant cast<br>When active, 20% of all damage taken by the caster is taken by your Imp, Voidwalker, Succubus, Felhunter, Felguard, or enslaved demon instead.  That damage cannot be prevented. Lasts as long as the demon is active and controlled."
		);
$i++;	
...
$rank[$i]= array(
		...
		&nbsp;Trainable Ranks Listed Below:<br>\
		&nbsp;Rank 2: 130 Mana, 123-140 Damage<br>\
		&nbsp;Rank 3: 190 Mana, 196-221 Damage<br>\
		&nbsp;Rank 4: 245 Mana, 274-307 Damage<br>\
		&nbsp;Rank 5: 305 Mana, 365-408 Damage<br>\
		&nbsp;Rank 6: 365 Mana, 468-520 Damage<br>\
		&nbsp;Rank 7: 435 Mana, 538-599 Damage<br>\
...
$rank[$i]= array(
		...
		&nbsp;Trainable Ranks Listed Below:<br>\
		&nbsp;Rank 2: 200 Mana, 326-407 Damage<br>\
		&nbsp;Rank 3: 230 Mana, 395-491 Damage<br>\
		&nbsp;Rank 4: 255 Mana, 455-566 Damage<br>\
		&nbsp;Rank 5: 280 Mana, 521-648 Damage<br>\
