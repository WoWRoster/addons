...
$talent[$i] = array(0, "Booming Echoes", 2, 1, 8); $i++; //UPDATED 3.1.0
$talent[$i] = array(0, "Elemental Oath", 2, 2, 8); $i++;
$talent[$i] = array(0, "Lightning Overload", 3, 3, 8); $i++;
...
$talent[$i] = array(1, "Unleashed Rage", 3, 1, 6); $i++;  
$talent[$i] = array(1, "Weapon Mastery", 3, 3, 6); $i++;
$talent[$i] = array(1, "Frozen Power", 2, 4, 6); $i++; //UPDATED 3.1.0
...
$talent[$i] = array(2, "Healing Grace", 3, 2, 2); $i++;
...
$talent[$i] = array(2, "Ancestral Healing", 3, 4, 3); $i++;
$talent[$i] = array(2, "Restorative Totems", 3, 2, 4); $i++;
...
//Elemental Reach Reach - Elemental //UPDATED 3.1.0
$rank[$i] = array(
...
//Elemental Mastery - Elemental	//UPDATED 3.1.0	
$rank[$i] = array(
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated, your next Lightning Bolt, Chain Lightning or Lava Burst spell becomes an instant cast spell. In addition, your Fire, Frost, and Nature damage spells a 15% increased critical strike chance for 15 sec. Elemental Mastery shares a cooldown with Nature\'s Swiftness."
		);
$i++;		
...
//Booming Echoes - Elemental //UPDATED 3.1.0
$rank[$i] = array(
...
//Totem of Wrath - Elemental //UPDATED 3.1.0
$rank[$i] = array(
	"5% of base mana<br>Instant cast<br>Tools: Fire Totem<br>Summons a Totem of Wrath with 5 health at the feet of the caster. The totem increases the spell power by 280 for all party and raid members, and increases the critical strike chance of all attacks 3% against all enemies within 40 yards. Lasts 5 min."
		);
$i++;	

//Lava Flows - Elemental //UPDATED 3.1.0
$rank[$i] = array(
...
//Thunderstorm - Elemental //UPDATED 3.1.0
$rank[$i] = array(
...
//Toughness - Enhancement //UPDATED 3.1.0
$rank[$i]= array(
...
//Unleashed Rage - Enhancement //UPDATED 3.1.0
$rank[$i] = array(
...
//Frozen Power - Enhancement //UPDATED 3.1.0
$rank[$i] = array(
...
$rank[$i]= array(
		"<span style=text-align:left;float:left;>8% of base mana</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>8 sec cooldown</span><br><span style=text-align:left;float:left;>Requires Melee Weapon</span><BR>Instantly attack with both weapons. In addition, the next 4 sources of Nature damage dealt to the target are increased by 20%. Lasts 12 sec."
		);
$i++;

//Static Shock - Enhancement //UPDATED 3.1.0
$rank[$i] = array(
...
//Improved Stormstrike - Enhancement //UPDATED 3.1.0
$rank[$i]= array(
...
//Shamanistic Rage - Enhancement  //UPDATED 3.1.0
$rank[$i]= array(
...
//Earthen Power - Enhancement //UPDATED 3.1.0
$rank[$i] = array(
...
//Healing Grace - Restoration //UPDATED 3.1.0
$rank[$i]= array(
...
"You have a 66% chance to instantly consume a Water Shield Orb when you gain a critical effect from your Healing Wave or Riptide spells, and a 40% chance when you gain a critical effect from your Lesser Healing Wave Spell.",
"You have a 100% chance to instantly consume a Water Shield Orb when you gain a critical effect from your Healing Wave or Riptide spells, and a 60% chance when you gain a critical effect from your Lesser Healing Wave Spell."
		);
$i++;		
	
//Healing Focus - Restoration   
$rank[$i]= array(
"Reduces the pushback suffered from damaging attacks while casting any healing spell by 23%.",
"Reduces the pushback suffered from damaging attacks while casting any healing spell by 46%.",
...
//Restorative Totems - Restoration //UPDATED 3.1.0
$rank[$i] = array(
...
//Nature\'s Swiftness - Restoration //UPDATED 3.1.0
$rank[$i]= array(
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>3 min cooldown</span><br>When activated, your next Nature spell with a base casting time less than 10 sec becomes an instant cast spell. Nature\'s Swiftness shares a cooldown with Elemental Mastery."
		);
$i++;	
...
$rank[$i]= array(
"<span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>5 min cooldown</span><br>Tools: Water Totem<br>Summons a Mana Tide Totem with 5 health at the feet of the caster for 12 sec that restores 6% of total mana every 3 seconds to group members within 30 yards."
		);
$i++;
