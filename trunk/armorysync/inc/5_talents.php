...
$talent[$i] = array(0, "Meditation", 3, 1, 3); $i++;
$talent[$i] = array(0, "Inner Focus", 1, 2, 3); $i++;
$talent[$i] = array(0, "Improved Power Word: Shield", 3, 3, 3); $i++;
$talent[$i] = array(0, "Absolution", 3, 1, 4); $i++;
$talent[$i] = array(0, "Mental Agility", 3, 2, 4); $i++;
$talent[$i] = array(0, "Improved Mana Burn", 2, 4, 4); $i++;
$talent[$i] = array(0, "Reflective Shield", 2, 1, 5); $i++;
$talent[$i] = array(0, "Mental Strength", 5, 2, 5); $i++;
$talent[$i] = array(0, "Soul Warding", 1, 3, 5); $i++; //UPDATED 3.1.0
$talent[$i] = array(0, "Focused Power", 2, 1, 6); $i++;
$talent[$i] = array(0, "Enlightenment", 3, 3, 6); $i++;
$talent[$i] = array(0, "Focused Will", 3, 1, 7); $i++;
$talent[$i] = array(0, "Power Infusion", 1, 2, 7); $i++;
$talent[$i] = array(0, "Improved Flash Heal", 3, 3, 7); $i++; //UPDATED 3.1.0
$talent[$i] = array(0, "Renewed Hope", 2, 1, 8); $i++;
$talent[$i] = array(0, "Rapture", 3, 2, 8); $i++;
...
$talent[$i] = array(1, "Body and Soul", 2, 1, 8); $i++; //UPDATED 3.1.0
$talent[$i] = array(1, "Empowered Healing", 5, 2, 8); $i++;
$talent[$i] = array(1, "Serendipity", 3, 3, 8); $i++;
$talent[$i] = array(1, "Empowered Renew", 3, 1, 9); $i++; //UPDATED 3.1.0
...
$talent[$i] = array(2, "Darkness", 5, 3, 1); $i++;
...
$talent[$i] = array(2, "Improved Devouring Plague", 3, 3, 6); $i++; //UPDATED 3.1.0
...
$talent[$i] = array(2, "Psychic Horror", 1, 1, 9); $i++;
...
//Silent Resolve - Discipline //UPDATED 3.1.0
$rank[$i] = array(
...
//Improved Power Word: Fortitude - Discipline //UPDATED 3.1.0		
$rank[$i] = array(
...
//Soul Warding - Discipline //UPDATED 3.1.0
$rank[$i] = array(
...
"Increases your total Stamina and Spirit by 5% and increases your spell haste by 6%."
		);
...
//Improved Flash Heal - Discipline //UPDATED 3.1.0
$rank[$i] = array(
...
//Renewed Hope - Discipline	 //UPDATED 3.1.0.9767 OLD: and Penance spells 
$rank[$i] = array(
...
//Rapture - Discipline 	 //UPDATED 3.1.0.9767 OLD: (1.5%/33% 1.5%/33% 1.5%/33%)
$rank[$i] = array(
...
//Grace - Discipline //UPDATED 3.1.0.9767 OLD: Grace,increasing
$rank[$i] = array(
...
//Penance - Discipline //UPDATED 3.1.0.9767 OLD: 288 Holy damage
$rank[$i]= array(
			"<span style=text-align:right;float:right;>Enemy: 30 yd range</span><br><span style=text-align:left;float:left;>16% of base mana</span><span style=text-align:right;float:right;>Friendly: 40 yd range</span><br><span style=text-align:left;float:left;>Channeled</span><span style=text-align:right;float:right;>10 sec cooldown</span><br>Launches a volley of holy light at the target, causing 240 Holy damage to an enemy, or 670 to 756 healing to an ally instantly and every .98 sec for 1.97 sec."
		);
...
//Blessed Recovery - Holy	//UPDATED 3.1.0
...
//Holy Concentration - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Blessed Resilience - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Body and Soul - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Serendipity - Holy //UPDATED 3.1.0
$rank[$i]= array(
...
//Empowered Renew - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Circle of Healing - Holy //UPDATED 3.1.0.9767 OLD: 684 to 756
$rank[$i]= array(
			"<span style=text-align:left;float:left;>15% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Heals up to 5 friendly party or raid members within 15 yards of the target for 373 to 409.<br><br>"
			);
$i++;

//Test of Faith - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Shadow Affinity - Shadow //UPDATED 3.1.0
$rank[$i]= array(
...
//Mind Flay - Shadow //UPDATED 3.1.0.9767 OLD: 386 Mana / 45 damage over 
$rank[$i]= array(
			"<span style=text-align:left;float:left;>9% of base mana</span><span style=text-align:right;float:right;>20 yd range</span><br>Channeled<br>Assault the target\'s mind with Shadow energy, causing 588 Shadow damage over 3 sec and slowing their movement speed by 50%."
		);
...
//Vampiric Embrace // UPDATED 3.1.0.9767 OLD: 2% of base mana CHECK IN CLIENT (Wowhead mana cost missing)
$rank[$i]= array(
			"<span style=text-align:left;float:left;>120 Mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>10 sec cooldown</span><br>Afflicts your target with Shadow energy that causes you to be healed by 15% and other party members to be healed for 3% of any Shadow spell damage you deal for 5 min."
		);
...
//Mind Melt - Shadow //UPDATED 3.1.0
$rank[$i]= array(
...
//Improved Devouring Plague - Shadow //UPDATED 3.1.0
$rank[$i] = array(
...
//Shadow Form - Shadoow  //UPDATED 3.1.0
$rank[$i]= array(
...
//Psychic Horror - Shadow //UPDATED 3.1.0
$rank[$i]= array(
			"<span style=text-align:left;float:left;>16% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>2 min cooldown</span><br>You terrify the target, causing them to tremble in horror for 3 sec and drop their main hand and ranged weapons for 10 sec."
		);
$i++;

//Vampiric Touch - Shadow   //UPDATED 3.1.0.9767 OLD: 380 to 284 damage 
$rank[$i]= array(
