...
$talent[$i] = array(1, "Primal Gore", 1, 3, 10); $i++; //UPDATED 3.1.0
...
$talent[$i] = array(2, "Nature\'s Bounty", 5, 3, 6); $i++; //UPDATED 3.1.0
...
$talent[$i] = array(2, "Revitalize", 3, 1, 9); $i++;
$talent[$i] = array(2, "Tree of Life", 1, 2, 9); $i++;
$talent[$i] = array(2, "Improved Tree of Life", 3, 3, 9); $i++;
$talent[$i] = array(2, "Improved Barkskin", 2, 1, 10); $i++; //UPDATED 3.1.0
...
//Nature\'s Grace - Balance //UPDATED 3.1.0
$rank[$i] = array(
...
//Celestial Focus - Balance  //UPDATED 3.1.0
$rank[$i] = array(
...
//Starfall - Balance  
$rank[$i] = array(
		"<span style=text-align:left;float:left;>35% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>3 min cooldown</span><br>You summon a flurry of stars from the sky on all targets within 30 yards of the caster, each doing 433 to 503 Arcane damage. Also causes 20 Arcane damage to other enemies within 5 yards of the enemy target. Maximum 20 stars. Lasts 10 sec. Shapeshifting into an animal form or mounting cancels the effect. Any effect which causes you to lose control of your character will supress the starfall effect."
		);
$i++;
//END BALANCE TALENTS
...
//Survival Instincts - Feral //UPDATED 3.1.0	
$rank[$i] = array(
...
//Predatory Strikes - Feral  //UPDATED 3.1.0
$rank[$i] = array(
...
//Heart of the Wild - Feral //UPDATED 3.1.0
$rank[$i]= array(
...
//Survival of the Fittest - Feral //UPDATED 3.1.0
$rank[$i]= array(
...
//Primal Tenacity - Feral //UPDATED 3.1.0
$rank[$i]= array(
"Reduces the duration of Fear effects by 10%, reduces all damage taken while Stunned by 10% while in Cat Form, and reduces the mana cost of Bear Form, Cat Form, and Dire Bear Form by 17%.",
"Reduces the duration of Fear effects by 20%, reduces all damage taken while Stunned by 20% while in Cat Form, and reduces the mana cost of Bear Form, Cat Form, and Dire Bear Form by 33%.",
"Reduces the duration of Fear effects by 30%, reduces all damage taken while Stunned by 30% while in Cat Form, and reduces the mana cost of Bear Form, Cat Form, and Dire Bear Form by 50%."
		);
$i++;
...
//Rend and Tear - Feral //UPDATED 3.1.0
$rank[$i] = array(
...
//Improved Mark of the Wild - Restoration //UPDATED 3.1.0
$rank[$i]= array(
...
//Subtlety - Restoration //UPDATED 3.1.0
$rank[$i]= array(
...
//Intensity - Restoration //UPDATED 3.1.0
$rank[$i]= array(
...
//Nature\'s Bounty - Restoration //UPDATED 3.1.0
$rank[$i]= array(
...
//Revitalize - Restoration //UPDATED 3.1.0
$rank[$i]= array(
...
//Tree of Life - Restoration  //UPDATED 3.1.0
$rank[$i]= array(
		"<span>28% of base mana</span><br><span>Instant cast</span><br>Reduces the mana cost of your healing over time spells by 20% and grants the ability to shapeshift into the Tree of Life. While in this form you increase healing received by 6% for all party and raid members within 45 yards, and you can only cast Restoration, Innervate, Barkskin, Nature\'s Grasp and Thorns spells.<br><br>The act of shapeshifting frees the caster of Polymorph and Movement Impairing effects."
		);
$i++;

//Improved Tree of Life - Restoration //UPDATED 3.1.0
$rank[$i]= array(
"Increases your armor contribution from items while in Tree of Life Form by 80%, and increases your healing spell power by 5% of your spirit while in Tree of Life Form.",
"Increases your armor contribution from items while in Tree of Life Form by 160%, and increases your healing spell power by 10% of your spirit while in Tree of Life Form.",
...
//Improved Barkskin - Restoration //UPDATED 3.1.0
$rank[$i] = array(
"Increases the damage reduction granted by your Barkskin spell by 5%, and increases resistance to Dispel mechanice by 30% while under the effect of Barkskin.",
"Increases the damage reduction granted by your Barkskin spell by 10%, and increases resistance to Dispel mechanice by 60% while under the effect of Barkskin."
		  );
$i++;
