...
$className = "Hunter Talents - Wrath of the Lich King Beta Talents";
...
$talent[$i] = array(2, "Improved Wing Clip", 3, 3, 2); $i++;
...
$talent[$i] = array(2, "Trap Mastery", 1, 2, 9); $i++;
$talent[$i] = array(2, "Sniper Training", 3, 4, 9); $i++;
$talent[$i] = array(2, "Hunting Party", 5, 3, 10); $i++;
...
$rank[$i] = array(
		"<span style=text-align:left;float:left;>75 Mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><BR><span style=text-align:left;float:left;>10 sec cooldown</span><br><br>Requires Ranged Weapon<br>An aimed shot that increases ranged damage by 70 and reduces healing done to that target by 50%. Lasts 10 sec.<br><br>\
...
$rank[$i]= array(
		"Instant cast<br>Increases the attack power of party and raid members within 45 yards by 10%. Lasts until cancelled.<br><br>\
		&nbsp;Trainable Ranks Listed Below:<br>\
...
302 Mana</span><span style=text-align:right;float:right;>\
...
$rank[$i]= array(
		"<span style=text-align:left;float:left;>375 Mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>10 sec cooldown</span><span style=text-align:left;float:left;>Requires Ranged Weapon</span><br><br/>You deal 125% weapon damage, refreshing the current Sting on your target and triggering an effect:<br/><br/> Serpent Sting - Instantly deals 40% of the damage done by your Serpent Sting.<br/><br/> Viper Sting - Instantly restores mana to you equal to 60% of the total amount drained by your Viper Sting.<br/><br/> Scorpid Sting - Attempts to Disarm the target for 10 sec. This effect cannot occur more than once per 1 minute."
		);
$i++;		
...
"You have a 66% chance when you trap a target and a 7% chance when you deal periodic damage with your Serpent Sing to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo. 30 second cooldown.",
"You have a 100% chance when you trap a target and a 10% chance when you deal periodic damage with your Serpent Sing to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo. 30 second cooldown." 
		);
$i++;	
...
$rank[$i]= array(
		"<span style=text-align:left;float:left;>555 Mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1 min cooldown</span><br><span style=text-align:left;float:left;>Requires Ranged Weapon</span>A stinging shot that puts the target to sleep for 12 sec. Any damage will cancel the effect. When the target wakes up, the Sting causes 300 Nature damage over 6 sec. Only one Sting per Hunter can be active on the target at a time.<br><br>\
		&nbsp;Trainable Ranks Listed Below:<br>\
...
$rank[$i]= array(
"Frost Trap and Freezing Trap - Increases the duration by 30%.<br/><br/>Immolation and Explosive Trap - Increases the periodic damage done by 30%.<br/><br/>Snake Trap - Increases the number of snakes summoned by 30%."
		);
$i++;	
...
$rank[$i] = array(
		"<span style=text-align:left;float:left;>504 Mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Requires Ranged Weapon<br>You fire an explosive charge into the target, dealing 214-246 Fire damage. The charge will blast the target every second for an additional 2 sec. "
		);
$i++;
?>
