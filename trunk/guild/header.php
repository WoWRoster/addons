...
if (!function_exists("makeContainerBottom")) {
	function makeContainerBottom() {
		$res = "";
		$res .= "</td>\n";
		$res .= "<td class=\"ContainerRight\" width=\"3\"><img src=\"images/blank.gif\"></td>\n";
		$res .= "</tr>\n";
		$res .= "<tr>\n";
		$res .= "<td colspan=\"3\">\n";
		$res .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n";
		$res .= "<td width=\"24\"><img src=\"images/container-4.gif\" width=\"24\" height=\"8\" border=\"0\"></td>\n";
		$res .= "<td style=\"background-image:url('images/container-5.gif')\"><img src=\"images/blank.gif\"></td>\n";
		$res .= "<td width=\"11\"><img src=\"images/container-6.gif\" width=\"11\" height=\"8\" border=\"0\"></td>\n";
		$res .= "</table>\n";
		$res .= "</td>\n";
		$res .= "</tr>\n";
		$res .= "</table>\n";
...
<table align="center" width="85%" cellpadding="0" cellspacing="0" border="0">
  <tr>
	...
	<td style="background-image: url('images/mainbox-top.gif')">
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
	    <tr>
		  <td width="46"><img src="images/bird-left-2-top.gif" width="46" height="40" border="0"></td>
		  <td><img src="images/blank.gif" width="2" height="2" border="0"></td>
		  <td width="46"><img src="images/bird-right-1-top.gif" width="46" height="40" border="0"></td>
		</tr>
	  </table>
	</td>
	<td width="25"><img src="images/bird-right-2-top.gif" width="25" height="40" border="0"></td>
  </tr>
  <tr>
    <td width="25" valign="top" class="MainLeftBar"><img src="images/bird-left-1-bottom.gif" width="25" height="25" border="0"></td>
	<td valign="top" style="background-image: url('images/bg-kalidar.jpg')">
	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	    <tr>
		  <td style="background-image: url('images/mainbox-top-remainder.gif')"><img src="images/blank.gif" width="2" height="3" border="0"></td>
		</tr>
		<tr>
	...
	<td width="25" valign="top" class="MainRightBar"><img src="images/bird-right-2-bottom.gif" width="25" height="25" border="0"></td>
  </tr>
  <tr>
    <td width="25"><img src="images/divider-left.gif" width="25" height="20" border="0"></td>
	<td height="20">
	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	    <tr>
	...
	<td width="25"><img src="images/divider-right.gif"></td>
  </tr>
  <tr>
    <td width="25" class="MainLeftBar"><img src="images/blank.gif" width="2" height="2" border="0"></td>
