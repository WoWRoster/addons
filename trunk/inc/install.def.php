...
class armorysyncInstall
{
	...
	function install()
	{
		...
		$installer->add_config("'1250', 'armorysync_use_ajax', 'off mandatory!', 'off', 'armorysync_conf'");
		$installer->add_config("'1300', 'armorysync_reloadwaittime', '24', 'text{4|4', 'armorysync_conf'");
