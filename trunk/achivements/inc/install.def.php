...
$installer->add_query("
CREATE TABLE `" . $installer->table('data') . "` (
`id` int(11) NOT NULL auto_increment,
  `member_id` int(11) NOT NULL,
  `guild_id` int(11) NOT NULL,
  `achv_cat` int(11) NOT NULL,
  `achv_cat_title` varchar(255) character set latin1 NOT NULL default '',
  `achv_cat_sub` varchar(255) character set latin1 NOT NULL default '',
  `achv_cat_sub2` int(10) default NULL,
  `achv_id` varchar(25) NOT NULL,
  `achv_points` int(11) NOT NULL,
  `achv_icon` varchar(255) character set latin1 NOT NULL default '',
  ...
  `achv_complete` varchar(255) character set latin1 NOT NULL default '',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM "); 

$installer->add_query("
CREATE TABLE `" . $installer->table('summary') . "` (
  `id` int(11) NOT NULL auto_increment,
  `member_id` int(11) NOT NULL,
  `guild_id` int(11) NOT NULL,
