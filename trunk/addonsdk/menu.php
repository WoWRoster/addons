...
$config['menu_index_file'][0][1] = $wordings[$roster_conf['roster_lang']]['dummyLink1'];   //<- menu link text, using the additional language settings in the addons localization.php file
