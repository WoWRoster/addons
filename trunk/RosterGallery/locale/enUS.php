...
$lang['admin']['tooltip10'] = "This option is used to set the active amount of cataories to display<br><font color=red> MUST! = The number of enabled catagories!</font>";
