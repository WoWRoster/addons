...
$backgFilesArr = $functions->listFiles( $adddir.$addon_cfg['rg_wm_dir'],array('png','jpeg','jpg') );
...
$menu .= '<li '.$first_tab.'>
                  <a href="#" rel="t1">'.$roster->locale->act['admin']['dispconfig'].'</a></li>';
$menu .= '    <li><a href="#" rel="t2">'.$roster->locale->act['admin']['uplodconfig'].'</a></li>'."\n";
$menu .= '    <li><a href="#" rel="t3">'.$roster->locale->act['admin']['thumbconfig'].'</a></li>'."\n";
$menu .= '    <li><a href="#" rel="t4">'.$roster->locale->act['admin']['catconfig'].'</a></li>'."\n";
$menu .= '    <li><a href="#" rel="t5">'.$roster->locale->act['admin']['apconfig'].'</a></li>'."\n";
$menu .= '    <li><a href="#" rel="t6">'.$roster->locale->act['admin']['unapconfig'].'</a></li>'."\n";
$menu .= '    <li><a href="#" rel="t9">'.$roster->locale->act['admin']['vote_config'].'</a></li>'."\n";
$menu .= '    <li><a href="#" rel="t10">'.$roster->locale->act['admin']['status_config'].'</a></li>'."\n";
...
if (isset($_GET['id']) != '' && isset($_GET['edit']) == 'cat'){
...
$roster->output['show_menu'] = false;
$sqle = "SELECT * FROM `" . ROSTER_SCREENTABLE . "` WHERE `id` = '".isset($_GET['id'])."'";
...
<tr>
<td>';
echo '<img src="' . $imgdirthumb.$rowe['file'].'-thumb.'.$rowe['ext'].'" ></a><br>';
echo '
</td>
</tr>
  <tr>
...
#-[ upload settings section ] ---
      ...
      $html .= '<tr>
            <td class="membersRow2" align="center"><div style="cursor:help;" onmouseover="overlib(\''.$roster->locale->act['admin']['tooltip23'].'\',CAPTION,\''.$roster->locale->act['admin']['tooltip23cap'].'\');" onmouseout="return nd();">'.$roster->locale->act['admin']['tooltip23cap'].'</div></td>
            <td class="membersRow2">'.$roster->locale->act['admin']['rg_upload_size'].': <input name="rg_upload_size" type="text" value="'.$addon_cfg['rg_upload_size'].'" size="5" maxlength="5" />
            </td>
            </tr>';
...
# -[ Catagory settings ] --
      ...
      $html .= '<tr>
            ...
            Disable <input type="radio" class="checkBox" name="rg_cat'.$n.'en" value="0" '.(!$addon_cfg['rg_cat'.$n.'en'] ? 'checked="checked"' : '' ).'/> 
              ...
              <tr>
    <td colspan="3" class="divider_sgreen"><img src="img/pixel.gif" width="1" height="1" alt="" /></td>
