...
echo border('sgreen','start',$wordings[$roster_conf['roster_lang']]['altlist_menu']).
     ...
     '<td><a href="?roster_addon_name='.$_GET['roster_addon_name'].'&amp;s='.$_GET['s'].'&amp;action='.$action.'&amp;altopen=yes"><img src="'.$subdir.$roster_conf['img_url'].'plus.gif" alt="+">'.$wordings['enUS']['altlist_open'].'</a>'.
     '<td><a href="?roster_addon_name='.$_GET['roster_addon_name'].'&amp;s='.$_GET['s'].'&amp;action='.$action.'&amp;altopen=no"><img src="'.$subdir.$roster_conf['img_url'].'minus.gif" alt="-">'.$wordings['enUS']['altlist_close'].'</a>'.
...
echo "<a href='?roster_addon_name=".$_GET['roster_addon_name']."&action=config'>".$wordings[$roster_conf['roster_lang']]['AltMonitor_config']."</a>";
