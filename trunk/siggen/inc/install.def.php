...
class siggen
{
	...
	var $fullname = 'SigGen';
	var $description = 'Signature and Avatar Generator.';
	var $credits = array(
		array(	"name"=>	"Zanix",
	...
	function install()
	{
		...
		{
			print errorMode($roster->locale->act['no_gd_error'],$roster->locale->act['fatal_error']);
			return;
		}
...
PRIMARY KEY  (`config_id`)");
	...
	function uninstall()
	{
		...
		$installer->remove_menu_button('menu_siggen_config');
