...
<!-- Begin Main Body -->
<form action="<?php print makelink(); ?>" method="post" enctype="multipart/form-data" id="config" name="config" onsubmit="submitonce(this)">
...
?>
	<table class="sc_table" cellspacing="0" cellpadding="2">
		...
		<tr>
			<td class="sc_row<?php echo (((++$row)%2)+1); ?>" align="left"><?php print $functions->createTip( 'This will generate an image and save it to the server disk for<br />EVERY character in the guild when update.php is ran in &quot;Guild Update&quot; mode<br /><br />PLEASE READ THE WARNING IN THE DOCUMENTATION<br />If you do get time-out errors, then you should disable this','Auto-save images on guild update' ); ?></td>
			<td class="sc_row_right<?php echo ((($row)%2)+1); ?>" align="right"><label>
	...
	<table class="sc_table" cellspacing="0" cellpadding="2">
		...
		<tr>
			...
			<td class="sc_row_right<?php echo ((($row)%2)+1); ?>" align="right">Description:<br />
				...
				Vert: <input name="skills_level_loc_y" type="text" value="<?php print $configData['skills_level_loc_y']; ?>" size="3" maxlength="3" /></td>
		</tr>
		<tr>
...
<?php print border('sgreen','start',"<div style=\"cursor:pointer;width:240px;\" onclick=\"swapShow('textT9Col','textT9')\"><img src=\"".$roster->config['img_url']."minus.gif\" style=\"float:right;\" alt=\"-\" />Talent Spec</div>"); ?>
        <table width="100%" class="sc_table" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td class="sc_row_right<?php echo ((($row)%2)+1); ?>" align="right">Horiz: <input name="text_spec_loc_x" type="text" value="<?php print $configData['text_spec_loc_x']; ?>" size="3" maxlength="3" /><br />
...
<?php print border('sgreen','start',"<div style=\"cursor:pointer;width:240px;\" onclick=\"swapShow('textT10Col','textT10')\"><img src=\"".$roster->config['img_url']."minus.gif\" style=\"float:right;\" alt=\"-\" />Talent Points</div>"); ?>
        <table width="100%" class="sc_table" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td class="sc_row_right<?php echo ((($row)%2)+1); ?>" align="right">Horiz: <input name="text_talpoints_loc_x" type="text" value="<?php print $configData['text_talpoints_loc_x']; ?>" size="3" maxlength="3" /><br />
