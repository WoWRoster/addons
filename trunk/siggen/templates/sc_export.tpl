...
<!-- Begin Settings Reset Box -->
  ...
  <div id="resetdbCol">
<?php print border('sgray','start','<div style="cursor:pointer;width:187px;" onclick="swapShow(\'resetdbCol\',\'resetdb\')"><img src="'.$roster->config['img_url'].'plus.gif" style="float:right;" alt="+" />Reset to Defaults</div>'); ?>
<?php print border('sgray','end'); ?>
  </div>
  <div id="resetdb" style="display:none;">
<?php print border('sgray','start','<div style="cursor:pointer;width:187px;" onclick="swapShow(\'resetdbCol\',\'resetdb\')"><img src="'.$roster->config['img_url'].'minus.gif" style="float:right;" alt="-" />Reset to Defaults</div>'); ?>
