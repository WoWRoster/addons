...
$className = "Rogue Talents - Wrath of the Lich King Beta Talents";
...
$talent[$i] = array(1, "Lightning Reflexes", 5, 3, 4); $i++;
...
$talent[$i] = array(1, "Murder Spree", 1, 2, 11); $i++;
...
$rank[$i] = array(
			"<span style=text-align:left;float:left;>30 Energy</span><br><span style=text-align:left;float:left;>Instant</span><br>Enrages you, increasing all damage caused by 3%. If used while a Bleeding is afflicting you, it will attempt to remove it and refund 15 energy. This effect can be stacked up to 3 times. Lasts 10 sec."
		);
$i++;
...
//Murder Spree - Combat
$rank[$i]= array(
			"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br>Step through the shadows from enemy to enemy within 10 yards, attacking an enemy every 0.5 secs with both weapons until 5 assaults are made. Can hit the same target multiple times."
		);
$i++;	
...
$rank[$i]= array(
			"30 yd range<br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br><span style=color:eb0504>Requires Stealth</span><br>When used, adds 2 combo points to your target. You must add to or use those combo points within 20 sec or the combo points are lost."
		);
$i++;	
