...
$i = 0;
$talent[$i] = array(0, "Improved Aspect of the Hawk", 5, 2, 1); $i++;
$talent[$i] = array(0, "Endurance Training", 5, 3, 1); $i++;
$talent[$i] = array(0, "Focused Fire", 2, 1, 2); $i++;
$talent[$i] = array(0, "Improved Aspect of the Monkey", 3, 2, 2); $i++; 
$talent[$i] = array(0, "Thick Hide", 3, 3, 2); $i++;
$talent[$i] = array(0, "Improved Revive Pet", 2, 4, 2); $i++;
$talent[$i] = array(0, "Pathfinding", 2, 1, 3); $i++;
$talent[$i] = array(0, "Aspect Mastery", 1, 2, 3); $i++;
$talent[$i] = array(0, "Unleashed Fury", 5, 3, 3); $i++;
$talent[$i] = array(0, "Improved Mend Pet", 2, 2, 4); $i++;
$talent[$i] = array(0, "Ferocity", 5, 3, 4); $i++;
$talent[$i] = array(0, "Spirit Bond", 2, 1, 5); $i++;
$talent[$i] = array(0, "Intimidation", 1, 2, 5); $i++;
$talent[$i] = array(0, "Bestial Discipline", 2, 4, 5); $i++;
$talent[$i] = array(0, "Animal Handler", 2, 1, 6); $i++;
$talent[$i] = array(0, "Frenzy", 5, 3, 6); $i++;
$talent[$i] = array(0, "Ferocious Inspiration", 3, 1, 7); $i++;
$talent[$i] = array(0, "Bestial Wrath", 1, 2, 7); $i++;
$talent[$i] = array(0, "Catlike Reflexes", 3, 3, 7); $i++;
$talent[$i] = array(0, "Invigoration", 2, 1, 8); $i++;
$talent[$i] = array(0, "Serpent\'s Swiftness", 5, 3, 8); $i++;
$talent[$i] = array(0, "Longevity", 3, 1, 9); $i++;
$talent[$i] = array(0, "The Beast Within", 1, 2, 9); $i++;
$talent[$i] = array(0, "Cobra Strikes", 3, 3, 9); $i++;
$talent[$i] = array(0, "Kindred Spirits", 5, 2, 10); $i++;
$talent[$i] = array(0, "Beast Mastery", 1, 2, 11); $i++;

$treeStartStop[$t] = $i -1;
$t++;

//marksmanship talents
$talent[$i] = array(1, "Improved Concussive Shot", 2, 1, 1); $i++;
$talent[$i] = array(1, "Focused Aim", 3, 2, 1); $i++;
$talent[$i] = array(1, "Lethal Shots", 5, 3, 1); $i++;
$talent[$i] = array(1, "Careful Aim", 3, 1, 2); $i++;
$talent[$i] = array(1, "Improved Hunter\'s Mark", 3, 2, 2); $i++;
$talent[$i] = array(1, "Mortal Shots", 5, 3, 2); $i++;
$talent[$i] = array(1, "Go for the Throat", 2, 1, 3); $i++;
$talent[$i] = array(1, "Improved Arcane Shot", 3, 2, 3); $i++;
$talent[$i] = array(1, "Aimed Shot", 1, 3, 3); $i++;
$talent[$i] = array(1, "Rapid Killing", 2, 4, 3); $i++;
$talent[$i] = array(1, "Improved Stings", 3, 2, 4); $i++;
$talent[$i] = array(1, "Efficiency", 5, 3, 4); $i++;
$talent[$i] = array(1, "Concussive Barrage", 2, 1, 5); $i++;
$talent[$i] = array(1, "Readiness", 1, 2, 5); $i++;
$talent[$i] = array(1, "Barrage", 3, 3, 5); $i++;
$talent[$i] = array(1, "Combat Experience", 2, 1, 6); $i++;
$talent[$i] = array(1, "Ranged Weapon Specialization", 3, 4, 6); $i++;
$talent[$i] = array(1, "Piercing Shots", 3, 1, 7); $i++;
$talent[$i] = array(1, "Trueshot Aura", 1, 2, 7); $i++;
$talent[$i] = array(1, "Improved Barrage", 3, 3, 7); $i++;
$talent[$i] = array(1, "Master Marksman", 5, 2, 8); $i++;
$talent[$i] = array(1, "Rapid Recuperation", 2, 3, 8); $i++;
$talent[$i] = array(1, "Wild Quiver", 3, 1, 9); $i++;
$talent[$i] = array(1, "Silencing Shot", 1, 2, 9); $i++;
$talent[$i] = array(1, "Improved Steady Shot", 3, 3, 9); $i++;
$talent[$i] = array(1, "Marked for Death", 5, 2, 10); $i++;
$talent[$i] = array(1, "Chimera Shot", 1, 2, 11); $i++;

$treeStartStop[$t] = $i -1;
$t++;

//survival talents
$talent[$i] = array(2, "Improved Tracking", 5, 1, 1); $i++;
$talent[$i] = array(2, "Hawk Eye", 3, 2, 1); $i++;
$talent[$i] = array(2, "Savage Strikes", 2, 3, 1); $i++;
$talent[$i] = array(2, "Surefooted", 3, 1, 2); $i++;
$talent[$i] = array(2, "Entrapment", 3, 2, 2); $i++;
$talent[$i] = array(2, "Trap Mastery", 3, 3, 2); $i++;
$talent[$i] = array(2, "Survival Instincts", 2, 4, 2); $i++;
$talent[$i] = array(2, "Survivalist", 5, 1, 3); $i++;
$talent[$i] = array(2, "Scatter Shot", 1, 2, 3); $i++;
$talent[$i] = array(2, "Deflection", 3, 3, 3); $i++;
$talent[$i] = array(2, "Survival Tactics", 2, 4, 3); $i++;
$talent[$i] = array(2, "T.N.T.", 3, 2, 4); $i++;
$talent[$i] = array(2, "Lock and Load", 3, 4, 4); $i++;
$talent[$i] = array(2, "Hunter vs. Wild", 3, 1, 5); $i++;
$talent[$i] = array(2, "Killer Instinct", 3, 2, 5); $i++;
$talent[$i] = array(2, "Counterattack", 1, 3, 5); $i++;
$talent[$i] = array(2, "Lightning Reflexes", 5, 1, 6); $i++;
$talent[$i] = array(2, "Resourcefulness", 3, 3, 6); $i++;
$talent[$i] = array(2, "Expose Weakness", 3, 1, 7); $i++;
...
$talent[$i] = array(2, "Hunting Party", 3, 3, 10); $i++;
$talent[$i] = array(2, "Explosive Shot", 1, 2, 11); $i++;
$treeStartStop[$t] = $i -1;
$t++;
...
//Animal Handler - Beast Mastery //UPDATED 3.1.0
$rank[$i] = array(
"Increases your pet\'s expertise by 5 and increases the duration of your Master\'s Call ability by 3 sec.",
"Increases your pet\'s expertise by 10 and increases the duration of your Master\'s Call ability by 6 sec."
		);
$i++;		
...
//Serpent\'s Swiftness - Beast Mastery //UPDATED 3.1.0
$rank[$i] = array(
...
//Kindred Spirits - Beast Mastery //UPDATED 3.1.0
$rank[$i]= array(
...
$rank[$i] = array(
		"<span style=text-align:left;float:left;>8% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><BR><span style=text-align:left;float:left;>10 sec cooldown</span><br><br>Requires Ranged Weapon<br>An aimed shot that increases ranged damage by 408 and reduces healing done to that target by 50%. Lasts 10 sec.<br><br>"
		);
$i++;		
...
//Improved Stings - Marksmanship //UPDATED 3.1.0
$rank[$i] = array(
"Increases the damage done by your Serpent Sting and Wyvern Sting by 10% and the mana drained by your Viper Sting by 10%. In addition, reduces the chance Sting damage over time effects will be dispelled by 10%.",
"Increases the damage done by your Serpent Sting and Wyvern Sting by 20% and the mana drained by your Viper Sting by 20%. In addition, reduces the chance Sting damage over time effects will be dispelled by 20%.",
"Increases the damage done by your Serpent Sting and Wyvern Sting by 30% and the mana drained by your Viper Sting by 30%. In addition, reduces the chance Sting damage over time effects will be dispelled by 30%."
		);
$i++;		

//Efficiency - Marksmanship //UPDATED 3.1.0
$rank[$i] = array(
...
//Readiness - Marksmanship //UPDATED 3.1.0
$rank[$i] = array(
...
$rank[$i]= array(
		"Instant cast<br>Increases the attack power of party and raid members within 45 yards by 10%. Lasts until cancelled."
		);
$i++;		
...
//Rapid Recuperation - Marksmanship //UPDATED 3.1.0
$rank[$i]= array(
...
//Wild Quiver - Marksmanship //UPDATED 3.1.0
$rank[$i]= array(
...
6% of base mana</span><span style=text-align:right;float:right;>\
...
//Marked for Death - Marksmanship //UPDATED 3.1.0
$rank[$i]= array(
"Increases your damage done by your shots and the damage done by your pet\'s special abilities by 1% on marked targets, and increases the critical strike damage bonus of your Aimed Shot, Arcane Shot, Steady Shot, Kill Shot or Chimera Shot by 2%.",
"Increases your damage done by your shots and the damage done by your pet\'s special abilities by 2% on marked targets, and increases the critical strike damage bonus of your Aimed Shot, Arcane Shot, Steady Shot, Kill Shot or Chimera Shot by 4%.",
"Increases your damage done by your shots and the damage done by your pet\'s special abilities by 3% on marked targets, and increases the critical strike damage bonus of your Aimed Shot, Arcane Shot, Steady Shot, Kill Shot or Chimera Shot by 6%.",
"Increases your damage done by your shots and the damage done by your pet\'s special abilities by 4% on marked targets, and increases the critical strike damage bonus of your Aimed Shot, Arcane Shot, Steady Shot, Kill Shot or Chimera Shot by 8%.",
"Increases your damage done by your shots and the damage done by your pet\'s special abilities by 5% on marked targets, and increases the critical strike damage bonus of your Aimed Shot, Arcane Shot, Steady Shot, Kill Shot or Chimera Shot by 10%."
);
$i++;		
	
	
//Chimera Shot - Survival
$rank[$i]= array(
		"<span style=text-align:left;float:left;>16% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>10 sec cooldown</span><span style=text-align:left;float:left;>Requires Ranged Weapon</span><br><br/>You deal 125% weapon damage, refreshing the current Sting on your target and triggering an effect:<br/><br/> Serpent Sting - Instantly deals 40% of the damage done by your Serpent Sting.<br/><br/> Viper Sting - Instantly restores mana to you equal to 60% of the total amount drained by your Viper Sting.<br/><br/> Scorpid Sting - Attempts to Disarm the target for 10 sec. This effect cannot occur more than once per 1 minute."
		);
$i++;		
...
//Entrapment - Survival //UPDATED 3.1.0
$rank[$i]= array(
"When your Frost Trap, Immolation Trap, Explosive Trap and Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 2 sec.",
"When your Frost Trap, Immolation Trap, Explosive Trap and Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 3 sec.",
"When your Frost Trap, Immolation Trap, Explosive Trap and Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 4 sec."
		);
$i++;

//Trap Mastery - Survival //UPDATED 3.1.0
$rank[$i] = array(
"Frost Trap and Freezing Trap - Increases the duration by 10%<br><br>Immolation Trap, Explosive Trap and Black Arrow - Increases the periodic damage done by 10%.<br><br>Snake Trap - Increases the number of snakes summoned by 3.",
"Frost Trap and Freezing Trap - Increases the duration by 20%<br><br>Immolation Trap, Explosive Trap and Black Arrow - Increases the periodic damage done by 20%.<br><br>Snake Trap - Increases the number of snakes summoned by 6.",
"Frost Trap and Freezing Trap - Increases the duration by 30%<br><br>Immolation Trap, Explosive Trap and Black Arrow - Increases the periodic damage done by 30%.<br><br>Snake Trap - Increases the number of snakes summoned by 9.",
		  );
$i++;
...
//Lock and Load - Survival //UPDATED 3.1.0
$rank[$i]= array(
"You have a 33% chance when you trap a target with Freezing Trap, Freezing Arrow or Frost trap and a 3% chance when you deal periodic damage with your Immolation Trap or Black Arrow to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo.",
"You have a 66% chance when you trap a target with Freezing Trap, Freezing Arrow or Frost trap and a 7% chance when you deal periodic damage with your Immolation Trap or Black Arrow to cause your next 2 Arcane Shot or Explosive Shot spells to trigger no cooldown, cost no mana and consume no ammo.",
...
//Resourcefulness - Survival //UPDATED 3.1.0
$rank[$i]= array(
...
//Wyvern Sting - Survival //UPDATED 3.1.0
$rank[$i]= array(
...
//Black Arrow - Survival //UPDATED 3.1.0
$rank[$i]= array(
		"<span style=text-align:left;float:left;>2% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Fires a Black Arrow at the target, increasing all damage done by you to the target by 6% and dealing 1009 Shadow damage over 15 sec. Black Arrow shares a cooldown with Trap spells.<br><br>"
		);
$i++;	
...
//Hunting Party - Survival //UPDATED 3.1.0
$rank[$i]= array(
"Increases your total Agility by an additional 1% and your Arcane Shot, Explosive Shot and Steady Shot critical strikes have a 33% chance to grant up to 10 party or raid members mana regeneration equal to 0.25% of the maximum mana per second. Last for 15 sec.",
"Increases your total Agility by an additional 2% and your Arcane Shot, Explosive Shot and Steady Shot critical strikes have a 66% chance to grant up to 10 party or raid members mana regeneration equal to 0.25% of the maximum mana per second. Last for 15 sec.",
"Increases your total Agility by an additional 3% and your Arcane Shot, Explosive Shot and Steady Shot critical strikes have a 100% chance to grant up to 10 party or raid members mana regeneration equal to 0.25% of the maximum mana per second. Last for 15 sec."
		);
$i++;	

//Explosive Shot - Survival //UPDATED 3.1.0
$rank[$i] = array(
