...
$talent[$i] = array(0, "Blessed Hands", 2, 4, 4); $i++;
...
$talent[$i] = array(0, "Sacred Cleansing", 3, 1, 8); $i++;
$talent[$i] = array(0, "Holy Guidance", 5, 3, 8); $i++;
$talent[$i] = array(0, "Divine Illumination", 1, 1, 9); $i++;
$talent[$i] = array(0, "Judgements of the Pure", 5, 3, 9); $i++;
$talent[$i] = array(0, "Infusion of Light", 2, 2, 10); $i++;
$talent[$i] = array(0, "Enlightened Judgements", 2, 3, 10); $i++;
...
$talent[$i] = array(1, "Divinity", 5, 2, 1); $i++;
...
$talent[$i] = array(1, "Divine Sacrifice", 1, 1, 3); $i++;
...
$talent[$i] = array(1, "Improved Hammer of Justice", 2, 2, 4); $i++;
...
$talent[$i] = array(1, "One-Handed Weapon Specialization", 3, 3, 6); $i++;
$talent[$i] = array(1, "Spiritual Attunement", 2, 1, 7); $i++;
$talent[$i] = array(1, "Holy Shield", 1, 2, 7); $i++;
$talent[$i] = array(1, "Ardent Defender", 3, 3, 7); $i++;
...
$talent[$i] = array(2, "Sanctity of Battle", 3, 3, 4); $i++;
...
$talent[$i] = array(2, "Divine Purpose", 2, 3, 6); $i++;
...
$talent[$i] = array(2, "Fanaticism", 3, 2, 8); $i++;
...
//Improved Concentration Aura - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Blessed Hands - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Pure of Heart - Holy 
$rank[$i] = array(
"Reduces the duration of Curse and Disease effects by 15%.",
"Reduces the duration of Curse and Disease effects by 30%."
		);
$i++;		
...
//Purifying Power - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Holy Shock - Holy	 	
$rank[$i] = array(
"<span style=text-align:right;float:right;>Enemy: 20 yd range</span><br><span style=text-align:left;float:left;>18% of base mana</span><span style=text-align:right;float:right;>Friendly: 40 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Blasts the target with Holy energy, causing 1296 to 1402 Holy damage to an enemy, or 2401 to 2599 healing to an ally."
		);
$i++;		
...
//Infusion of Light - Holy //UPDATED 3.1.0
$rank[$i] = array(
"Your Holy Shock critical hits reduce the cast time of your next Flash of Light spell by 0.75 sec or increase the critical strike chance of your next Holy Light by 10%.",
"Your Holy Shock critical hits reduce the cast time of your next Flash of Light spell by 1.5 sec or increase the critical strike chance of your next Holy Light by 20%."
		);
$i++;


//Enlightened Judgements - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
$rank[$i] = array(
		"<span style=text-align:left;float:left;>35% of base mana</span><span style=text-align:right;float:right;>40 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><br>The target becomes a Beacon of Light to all targets within a 40 yard radius. Any heals you cast on those targets will also heal the Beacon for 100% of the amount healed. Only one target can be Beacon of Light at a time. Lasts 1 min."
		);
$i++;
...
//Divinity - Protection //UPDATED 3.1.0
$rank[$i] = array(
...
//Stoicism - Protection //UPDATED 3.1.0
$rank[$i] = array(
...
//Divine Sacrifice - Protection //UPDATED 3.1.0
$rank[$i] = array(
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>2 min cooldown</span><br>30% of all damage taken by party or raid members within 30 yards is redirected to the Paladin (up to a maximum of 150% of the Paladin\'s health). Lasts 10 sec."
		);
$i++;	
...
//Divine Guardian - Protection //UPDATED 3.1.0
$rank[$i] = array(
...
//Improved Devotion Aura - Protection //UPDATED 3.1.0
$rank[$i] = array(
...
//Spiritual Attunement - Protection //UPDATED 3.1.0
$rank[$i] = array(
"A passive ability that gives the Paladin mana when healed by other friendly target\'s spells. The amount of mana gained is equal to 5% of the amount healed.",
"A passive ability that gives the Paladin mana when healed by other friendly target\'s spells. The amount of mana gained is equal to 10% of the amount healed."
	 	  );
$i++;
...
$rank[$i] = array(
		"<span style=text-align:left;float:left;>26% of base mana</span><span style=text-align:right;float:right;>30 yd range</span><br><span style=text-align:left;float:left;>Instant Cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Hurls a holy shield at the enemy, dealing 376 to 450 Holy damage, Dazing them and then jumping to additional nearby enemies. Affects 3 total targets. Lasts 10 sec.<br><br>"
		);
$i++;

//Guarded by the Light - Protection //UPDATED 3.1.0
$rank[$i]= array(
...
//Shield of the Templar - Protection  //UPDATED 3.1.0
$rank[$i]= array(
...
//Judgements of the Just - Protection //UPDATED 3.1.0
$rank[$i] = array(
...
$rank[$i]= array(
"14% of base mana<br/>Instant cast<br/>Gives the Paladin a chance to deal 62 to 64 additional Holy damage. Only one Seal can be active on the Paladin at any one time. Lasts 30 min.<br/><br/>	Unleasing this Seal\'s energy will judge an enemy, instantly causing 145 to 146 Holy damage. This attack will always be a critical strike if the target is stunned or incapacitated.<br><br>"
		);
$i++;		
...
//Sanctity of Battle - Retribution //UPDATED 3.1.0
$rank[$i]= array(
...
//Sanctified Retribution - Holy //UPDATED 3.1.0
$rank[$i] = array(
...
//Judgements of the Wise- Retribution //UPDATED 3.1.0
$rank[$i]= array(
...
"Your Judgement spells have a 100% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 0.25% of their maximum mana per second for 15 sec, and to immediately grant you 25% of your base mana."
		);
$i++;
...
//Swift Retribution - Retribution //UPDATED 3.1.0
$rank[$i]= array(
...
//Divine Storm - Retribution //UPDATED 3.1.0
$rank[$i]= array(
