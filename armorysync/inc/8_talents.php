...
$i = 0;
$talent[$i] = array(0, "Arcane Subtlety", 2, 1, 1); $i++;
$talent[$i] = array(0, "Arcane Focus", 3, 2, 1); $i++;
$talent[$i] = array(0, "Arcane Stability", 5, 3, 1); $i++;
$talent[$i] = array(0, "Arcane Fortitude", 3, 1, 2); $i++;
$talent[$i] = array(0, "Magic Absorption", 2, 2, 2); $i++;
$talent[$i] = array(0, "Arcane Concentration", 5, 3, 2); $i++;
$talent[$i] = array(0, "Magic Attunement", 2, 1, 3); $i++;
$talent[$i] = array(0, "Spell Impact", 3, 2, 3); $i++;
$talent[$i] = array(0, "Student of the Mind", 3, 3, 3); $i++;
$talent[$i] = array(0, "Focus Magic", 1, 4, 3); $i++;
$talent[$i] = array(0, "Arcane Shielding", 2, 1, 4); $i++;
$talent[$i] = array(0, "Improved Counterspell", 2, 2, 4); $i++;
$talent[$i] = array(0, "Arcane Meditation", 3, 3, 4); $i++;
$talent[$i] = array(0, "Torment the Weak", 3, 4, 4); $i++;
$talent[$i] = array(0, "Improved Blink", 2, 1, 5); $i++;
$talent[$i] = array(0, "Presence of Mind", 1, 2, 5); $i++;
$talent[$i] = array(0, "Arcane Mind", 5, 4, 5); $i++;
$talent[$i] = array(0, "Prismatic Cloak", 3, 1, 6); $i++;
$talent[$i] = array(0, "Arcane Instability", 3, 2, 6); $i++;
$talent[$i] = array(0, "Arcane Potency", 2, 3, 6); $i++;
$talent[$i] = array(0, "Arcane Empowerment", 3, 1, 7); $i++;
$talent[$i] = array(0, "Arcane Power", 1, 2, 7); $i++;
$talent[$i] = array(0, "Incanter\'s Absorption", 3, 3, 7); $i++;
$talent[$i] = array(0, "Arcane Flows", 2, 2, 8); $i++;
$talent[$i] = array(0, "Mind Mastery", 5, 3, 8); $i++;
$talent[$i] = array(0, "Slow", 1, 2, 9); $i++;
$talent[$i] = array(0, "Missile Barrage", 5, 3, 9); $i++;
$talent[$i] = array(0, "Netherwind Presence", 3, 2, 10); $i++;
$talent[$i] = array(0, "Spell Power", 2, 3, 10); $i++;
$talent[$i] = array(0, "Arcane Barrage", 1, 2, 11); $i++;
$treeStartStop[$t] = $i -1;
$t++;

//fire talents
$talent[$i] = array(1, "Improved Fire Blast", 2, 1, 1); $i++;
$talent[$i] = array(1, "Incineration", 3, 2, 1); $i++;
$talent[$i] = array(1, "Improved Fireball", 5, 3, 1); $i++;
$talent[$i] = array(1, "Ignite", 5, 1, 2); $i++;
$talent[$i] = array(1, "Burning Determination", 2, 2, 2); $i++;
$talent[$i] = array(1, "World in Flames", 3, 3, 2); $i++;
$talent[$i] = array(1, "Flame Throwing", 2, 1, 3); $i++;
$talent[$i] = array(1, "Impact", 3, 2, 3); $i++;
$talent[$i] = array(1, "Pyroblast", 1, 3, 3); $i++;
$talent[$i] = array(1, "Burning Soul", 2, 4, 3); $i++;
$talent[$i] = array(1, "Improved Scorch", 3, 1, 4); $i++;
$talent[$i] = array(1, "Molten Shields", 2, 2, 4); $i++;
$talent[$i] = array(1, "Master of Elements", 3, 4, 4); $i++;
$talent[$i] = array(1, "Playing with Fire", 3, 1, 5); $i++;
$talent[$i] = array(1, "Critical Mass", 3, 2, 5); $i++;
$talent[$i] = array(1, "Blast Wave", 1, 3, 5); $i++;
$talent[$i] = array(1, "Blazing Speed", 2, 1, 6); $i++;
$talent[$i] = array(1, "Fire Power", 5, 3, 6); $i++;
$talent[$i] = array(1, "Pyromaniac", 3, 1, 7); $i++;
$talent[$i] = array(1, "Combustion", 1, 2, 7); $i++;
$talent[$i] = array(1, "Molten Fury", 2, 3, 7); $i++;
$talent[$i] = array(1, "Fiery Payback", 2, 1, 8); $i++;
$talent[$i] = array(1, "Empowered Fire", 3, 3, 8); $i++;
$talent[$i] = array(1, "Firestarter", 2, 1, 9); $i++;
$talent[$i] = array(1, "Dragon\'s Breath", 1, 2, 9); $i++;
$talent[$i] = array(1, "Hot Streak", 3, 3, 9); $i++;
$talent[$i] = array(1, "Burnout", 5, 2, 10); $i++;
$talent[$i] = array(1, "Living Bomb", 1, 2, 11); $i++;
...
//frost talents
$talent[$i] = array(2, "Frostbite", 3, 1, 1); $i++;
$talent[$i] = array(2, "Improved Frostbolt", 5, 2, 1); $i++;
$talent[$i] = array(2, "Ice Floes", 3, 3, 1); $i++;
$talent[$i] = array(2, "Ice Shards", 3, 1, 2); $i++;
$talent[$i] = array(2, "Frost Warding", 2, 2, 2); $i++;
$talent[$i] = array(2, "Precision", 3, 3, 2); $i++; //UPDATED 3.1.0
$talent[$i] = array(2, "Permafrost", 3, 4, 2); $i++;
$talent[$i] = array(2, "Piercing Ice", 3, 1, 3); $i++;
$talent[$i] = array(2, "Icy Veins", 1, 2, 3); $i++;
$talent[$i] = array(2, "Improved Blizzard", 3, 3, 3); $i++;
$talent[$i] = array(2, "Arctic Reach", 2, 1, 4); $i++;
$talent[$i] = array(2, "Frost Channeling", 3, 2, 4); $i++;
$talent[$i] = array(2, "Shatter", 3, 3, 4); $i++;
$talent[$i] = array(2, "Cold Snap", 1, 2, 5); $i++;
$talent[$i] = array(2, "Improved Cone of Cold", 3, 3, 5); $i++;
$talent[$i] = array(2, "Frozen Core", 3, 4, 5); $i++;
$talent[$i] = array(2, "Cold as Ice", 2, 1, 6); $i++;
$talent[$i] = array(2, "Winter\'s Chill", 3, 3, 6); $i++;
$talent[$i] = array(2, "Shattered Barrier", 2, 1, 7); $i++;
$talent[$i] = array(2, "Ice Barrier", 1, 2, 7); $i++;
$talent[$i] = array(2, "Arctic Winds", 5, 3, 7); $i++;
$talent[$i] = array(2, "Empowered Frostbolt", 2, 2, 8); $i++;
$talent[$i] = array(2, "Fingers of Frost", 2, 3, 8); $i++;
$talent[$i] = array(2, "Brain Freeze", 3, 1, 9); $i++;
$talent[$i] = array(2, "Summon Water Elemental", 1, 2, 9); $i++;
$talent[$i] = array(2, "Enduring Winter", 3, 3, 9); $i++; //UPDATED 3.1.0
$talent[$i] = array(2, "Chilled to the Bone", 5, 2, 10); $i++;
$talent[$i] = array(2, "Deep Freeze", 1, 2, 11); $i++;
$treeStartStop[$t] = $i -1;
$t++;
...
//Arcane Subtlety - Arcane //UPDATED 3.1.0
$rank[$i] = array(
		"Reduces the chance your helpful spells and damages over time effects will be dispelled by 15% and reduces the threat caused by your Arcane spells by 20%.",
		"Reduces the chance your helpful spells and damages over time effects will be dispelled by 30% and reduces the threat caused by your Arcane spells by 40%."
		);
$i++;		
...
//Focus Magic - Arcane //UPDATED 3.1.0
$rank[$i] = array(
...
//Arcane Meditation - Arcane //UPDATED 3.1.0
$rank[$i] = array(
...
//Presence of Mind - Arcane //UPDATED 3.1.0
$rank[$i] = array(
...
//Arcane Power - Arcane	 //UPDATED 3.1.0			
$rank[$i] = array(
...
//Arcane Flows - Arcane //UPDATED 3.1.0
$rank[$i]= array(
...
//Fiery Payback - Fire	//UPDATED 3.1.0
$rank[$i] = array(
"When below 35% health all damage taken is reduced by 10% and your Pyroblast spell\'s cast time is reduced by 1.8 secs while the cooldown is increased by 2.5 secs. In addition, melee and ranged attacks made against you have a 5% chance to disarm your attacker\'s main hand and ranged weapons.",
...
//Living Bomb - Fire				
$rank[$i] = array(
		"35 yd range</span><br><br><span style=text-align:left;float:left;>Instant</span><BR>The target becomes a Living Bomb, taking 1380 Fire Damage over 12 sec. After 12 sec or when the spell is dispelled, the target explodes dealing 330 Fire damage to all enemies within 10 yards. This spell can only affect one target at a time.<br><br>"
		);
$i++;
...
//Winter\'s Chill - Frost //UPDATED 3.1.0
$rank[$i]= array(
...
//Ice Barrier - Frost
$rank[$i]= array(
		"<span style=text-align:left;float:left;>25% of base mana</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Instantly shields you, absorbing 3300 damage. Lasts 1 min. While the shield holds, spellcasting will not be delayed by damage.<br><br>"
		);
$i++;	
...
//Enduring Winter - Frost //UPDATED 3.1.0
$rank[$i]= array(
"Increases the duration of your Summon Water Elemental spell by 5 sec and your Frostbolt spell has a 33% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 0.25% of their maximum mana per second for 15 sec.",
"Increases the duration of your Summon Water Elemental spell by 10 sec and your Frostbolt spell has a 66% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 0.25% of their maximum mana per second for 15 sec.",
"Increases the duration of your Summon Water Elemental spell by 15 sec and your Frostbolt spell has a 100% chance to grant the Replenishment effect to up to 10 party or raid members mana regeneration equal to 0.25% of their maximum mana per second for 15 sec."
		);
$i++;
