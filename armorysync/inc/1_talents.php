...
$talent[$i] = array(0, "Improved Heroic Strike", 3, 1, 1); $i++;
$talent[$i] = array(0, "Deflection", 5, 2, 1); $i++;
$talent[$i] = array(0, "Improved Rend", 2, 3, 1); $i++;
$talent[$i] = array(0, "Improved Charge", 2, 1, 2); $i++; 
$talent[$i] = array(0, "Iron Will", 3, 2, 2); $i++;
$talent[$i] = array(0, "Tactical Mastery", 3, 3, 2); $i++;
$talent[$i] = array(0, "Improved Overpower", 2, 1, 3); $i++;
$talent[$i] = array(0, "Anger Management", 1, 2, 3); $i++;
$talent[$i] = array(0, "Impale", 2, 3, 3); $i++;
$talent[$i] = array(0, "Deep Wounds", 3, 4, 3); $i++;
$talent[$i] = array(0, "Two-Handed Weapon Specialization", 3, 2, 4); $i++;
$talent[$i] = array(0, "Taste for Blood", 3, 3, 4); $i++;
$talent[$i] = array(0, "Poleaxe Specialization", 5, 1, 5); $i++; 
$talent[$i] = array(0, "Sweeping Strikes", 1, 2, 5); $i++;
$talent[$i] = array(0, "Mace Specialization", 5, 3, 5); $i++;
$talent[$i] = array(0, "Sword Specialization", 5, 4, 5); $i++;
$talent[$i] = array(0, "Weapon Mastery", 2, 1, 6); $i++; //UPDATED 3.1.0
$talent[$i] = array(0, "Improved Hamstring", 3, 3, 6); $i++;
$talent[$i] = array(0, "Trauma", 2, 4, 6); $i++;
$talent[$i] = array(0, "Second Wind", 2, 1, 7); $i++;
$talent[$i] = array(0, "Mortal Strike", 1, 2, 7); $i++;
$talent[$i] = array(0, "Strength of Arms", 2, 3, 7); $i++;
$talent[$i] = array(0, "Improved Slam", 2, 4, 7); $i++;
$talent[$i] = array(0, "Juggernaut", 1, 1, 8); $i++; //UPDATED 3.1.0
$talent[$i] = array(0, "Improved Mortal Strike", 3, 2, 8); $i++;
$talent[$i] = array(0, "Unrelenting Assault", 2, 3, 8); $i++;
$talent[$i] = array(0, "Sudden Death", 3, 1, 9); $i++;
$talent[$i] = array(0, "Endless Rage", 1, 2, 9); $i++;
$talent[$i] = array(0, "Blood Frenzy", 2, 3, 9); $i++;
$talent[$i] = array(0, "Wrecking Crew", 5, 2, 10); $i++;
$talent[$i] = array(0, "Bladestorm", 1, 2, 11); $i++;

$treeStartStop[$t] = $i -1;
$t++;

//fury talents
$talent[$i] = array(1, "Armored to the Teeth", 3, 1, 1); $i++;
$talent[$i] = array(1, "Booming Voice", 2, 2, 1); $i++;
$talent[$i] = array(1, "Cruelty", 5, 3, 1); $i++;
$talent[$i] = array(1, "Improved Demoralizing Shout", 5, 2, 2); $i++;
$talent[$i] = array(1, "Unbridled Wrath", 5, 3, 2); $i++;
$talent[$i] = array(1, "Improved Cleave", 3, 1, 3); $i++;
$talent[$i] = array(1, "Piercing Howl", 1, 2, 3); $i++;
$talent[$i] = array(1, "Blood Craze", 3, 3, 3); $i++;
$talent[$i] = array(1, "Commanding Presence", 5, 4, 3); $i++;
$talent[$i] = array(1, "Dual Wield Specialization", 5, 1, 4); $i++;
$talent[$i] = array(1, "Improved Execute", 2, 2, 4); $i++;
$talent[$i] = array(1, "Enrage", 5, 3, 4); $i++;
$talent[$i] = array(1, "Precision", 3, 1, 5); $i++;
$talent[$i] = array(1, "Death Wish", 1, 2, 5); $i++;
$talent[$i] = array(1, "Improved Intercept", 2, 3, 5); $i++; //UPDATED 3.1.0
$talent[$i] = array(1, "Improved Berserker Rage", 2, 1, 6); $i++;
$talent[$i] = array(1, "Flurry", 5, 3, 6); $i++;
$talent[$i] = array(1, "Intensify Rage", 3, 1, 7); $i++;
$talent[$i] = array(1, "Bloodthirst", 1, 2, 7); $i++;
$talent[$i] = array(1, "Improved Whirlwind", 2, 4, 7); $i++;
$talent[$i] = array(1, "Furious Attacks", 2, 1, 8); $i++;
$talent[$i] = array(1, "Improved Berserker Stance", 5, 4, 8); $i++;
$talent[$i] = array(1, "Heroic Fury", 1, 1, 9); $i++;
$talent[$i] = array(1, "Rampage", 1, 2, 9); $i++;
$talent[$i] = array(1, "Bloodsurge", 3, 3, 9); $i++;
$talent[$i] = array(1, "Unending Fury", 5, 2, 10); $i++;
$talent[$i] = array(1, "Titan\'s Grip", 1, 2, 11); $i++;
...
//protection talents
$talent[$i] = array(2, "Improved Bloodrage", 2, 1, 1); $i++;
$talent[$i] = array(2, "Shield Specialization", 5, 2, 1); $i++;
$talent[$i] = array(2, "Improved Thunder Clap", 3, 3, 1); $i++;
$talent[$i] = array(2, "Incite", 3, 2, 2); $i++;
$talent[$i] = array(2, "Anticipation", 5, 3, 2); $i++;
$talent[$i] = array(2, "Last Stand", 1, 1, 3); $i++;
$talent[$i] = array(2, "Improved Revenge", 2, 2, 3); $i++;
$talent[$i] = array(2, "Shield Mastery", 2, 3, 3); $i++;
$talent[$i] = array(2, "Toughness", 5, 4, 3); $i++;
$talent[$i] = array(2, "Improved Spell Reflection", 2, 1, 4); $i++;
$talent[$i] = array(2, "Improved Disarm", 2, 2, 4); $i++;
$talent[$i] = array(2, "Puncture", 3, 3, 4); $i++;
$talent[$i] = array(2, "Improved Disciplines", 2, 1, 5); $i++;
$talent[$i] = array(2, "Concussion Blow", 1, 2, 5); $i++;
$talent[$i] = array(2, "Gag Order", 2, 3, 5); $i++;
$talent[$i] = array(2, "One-Handed Weapon Specialization", 5, 3, 6); $i++;
$talent[$i] = array(2, "Improved Defensive Stance", 2, 1, 7); $i++;
$talent[$i] = array(2, "Vigilance", 1, 2, 7); $i++;
$talent[$i] = array(2, "Focused Rage", 3, 3, 7); $i++;
$talent[$i] = array(2, "Vitality", 3, 2, 8); $i++;
$talent[$i] = array(2, "Safeguard", 2, 3, 8); $i++;
$talent[$i] = array(2, "Warbringer", 1, 1, 9); $i++;
$talent[$i] = array(2, "Devastate", 1, 2, 9); $i++;
$talent[$i] = array(2, "Critical Block", 3, 3, 9); $i++;
$talent[$i] = array(2, "Sword and Board", 3, 2, 10); $i++;
$talent[$i] = array(2, "Damage Shield", 2, 3, 10); $i++;
$talent[$i] = array(2, "Shockwave", 1, 2, 11); $i++;
...
//Taste for Blood - Arms //UPDATED 3.1.0
$rank[$i] = array(
"Whenever your Rend ability causes damage, you have a 33% chance of allowing the use of your Overpower ability for 9 sec. 1 charge. This effect will not occur more than once ever 6 sec.",
"Whenever your Rend ability causes damage, you have a 66% chance of allowing the use of your Overpower ability for 9 sec. 1 charge. This effect will not occur more than once ever 6 sec.",
"Whenever your Rend ability causes damage, you have a 100% chance of allowing the use of your Overpower ability for 9 sec. 1 charge. This effect will not occur more than once ever 6 sec."
		);
$i++;
...
$rank[$i] = array(
"30 Rage<br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>30 sec cooldown</span><br>Requires Battle Stance, Berserker Stance<br>Your next 5 melee attacks strike an additional nearby opponent."
		);
$i++;
...
//Mortal Strike - Arms 
$rank[$i] = array(
		"<span style=text-align:left;float:left;>30 Rage</span><span style=text-align:right;float:right;>Melee range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>Requires Melee Weapon<br>A vicious strike that deals weapon damage plus 380 and wounds the target, reducing the effectiveness of any healing by 50% for 10 sec.<br><br>"
		);		
$i++;
...
//Juggernaut - Arms //UPDATED 3.1.0
$rank[$i] = array(
"Your Charge ability is now usable while in combat. Following a Charge, your next Slam or Mortal Strike has an additional 100% chance to critically hit if used within 10 sec."
		  );
$i++;
...
//Unrelenting Assault - Arms //UPDATED 3.1.0
$rank[$i] = array(
...
//Sudden Death - Arms //UPDATED 3.1.0
$rank[$i] = array(
"Your melee critical hits have a 3% chance of allowing the use of Execute regardless of the target\'s health state. This Execute only uses up to 30 total rage. In addition, you keep 3 rage after using Execute.",
"Your melee critical hits have a 6% chance of allowing the use of Execute regardless of the target\'s health state. This Execute only uses up to 30 total rage. In addition, you keep 7 rage after using Execute.",
"Your melee critical hits have a 9% chance of allowing the use of Execute regardless of the target\'s health state. This Execute only uses up to 30 total rage. In addition, you keep 10 rage after using Execute."
		);
$i++;
...
//Wrecking Crew - Arms //UPDATED 3.1.0
$rank[$i] = array(
...
//Improved Intercept - Fury //UPDATED 3.1.0
$rank[$i] = array(
...
//Bloodthirst - Fury // CHECK IN CLIENT (Error on WowHead)
$rank[$i]= array(
		"<span style=text-align:left;float:left;>30 Rage</span><span style=text-align:right;float:right;>Melee range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>5 sec cooldown</span><br>Instantly attack the target causing 290 damage. In addition, the next 3 successful melee attacks will restore 1% of max health. This effect lasts 8 sec. Damage is based on your attack power."
		);
$i++;	
...
//Improved Berserker Stance - Fury //UPDATED 3.1.0
$rank[$i]= array(
...
//Titan\'s Grip - Fury //UPDATED 3.1.0
$rank[$i] = array(
"Allows you to equip two-handed axes, maces and swords in one hand. While you have a two-handed weapon equipped in one hand, your phyiscal damage done is reduced by 10%."
		);
$i++;
...
//Improved Spell Reflection - Protection //UPDATED 3.1.0
$rank[$i]= array(
...
//Concussion Blow - Protection // CHECK IN CLIENT
$rank[$i]= array(
...
//Warbringer - Protection // UPDATED 3.1.0.9767 OLD: Your Charge ability is now usable 
$rank[$i] = array(
