...
$className = "Warrior Talents - Wrath of the Lich King Beta Talents";
...
$talent[$i] = array(0, "Improved Intercept", 2, 1, 6); $i++;
...
$talent[$i] = array(1, "Weapon Mastery", 2, 3, 5); $i++;
...
//Bloodthirst - Fury
$rank[$i]= array(
		"<span style=text-align:left;float:left;>30 Rage</span><span style=text-align:right;float:right;>Melee range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>5 sec cooldown</span><br>Instantly attack the target causing 260 damage. In addition, the next 5 successful melee attacks will restore 0.6% of max health. This effect lasts 8 sec. Damage is based on your attack power."
		);
$i++;	
...
$rank[$i]= array(
		"<span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>5 min cooldown</span><br>When activated, this ability temporarily grants you 30% of your maximum health for 20 sec. After the effect expires, the health is lost."
		);
$i++;		
...
$rank[$i]= array(
		"<span style=text-align:left;float:left;>15 Rage</span><span style=text-align:right;float:right;>Melee Range</span><br>Instant<br>Requires One-Handed Melee Weapon<br>Sunder the target\'s armor causing the Sunder Armor effect.  In addition, causes 50% of weapon damage plus 24 for each application of Sunder Armor on the target.  The Sunder Armor effect can stack up to 5 times.<br><br>\
		&nbsp;Trainable Ranks Listed Below:<br>&nbsp;&nbsp;Rank 2: +25 Damage<br>&nbsp;&nbsp;Rank 3: +35 Damage<br>&nbsp;&nbsp;Rank 4: +53 Damage<br>&nbsp;&nbsp;Rank 5: +63 Damage<br>"
		);
$i++;	
...
//Shockwave - Prtection
$rank[$i] = array(
"<span style=text-align:left;float:left;>15 Rage</span><span style=text-align:right;float:right;>Melee Range</span><br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>20 sec cooldown</span><br>Sends a wave of force in front of the warrior, causing 426 damage (based on attack	power) and stunning all enemy targets within 10 yards in a frontal cone for 4 sec."
		);		
$i++;
