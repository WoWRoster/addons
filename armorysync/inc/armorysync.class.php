...
class ArmorySync extends ArmorySyncBase {
     ...
     */
      function _getReputationInfo() 
      {
            ...
            $content =  $armory->getCharacterRep('http://www.wowarmory.com', $this->server,$this->memberName);    
    ...
    function _getTalentInfo() 
    {
		...
		$fromCache = false;
            ...
            $content = $armory->getTalentData('http://www.wowarmory.com/', $this->server, $this->memberName );
