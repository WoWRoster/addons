...
$tablename = ROSTER_SORTMEMBER_CONFIG_TABLE;
include($addonDir.'inc/config.php');
...
'   <li><a href="http://www.wowroster.net/wiki/index.php/Roster:Addon:SortMember" target="_new">'.$wordings[$roster_conf['roster_lang']]['documentation'].'</a></li>
...
print '
<span class="title_text">'.$wordings[$roster_conf['roster_lang']]['SortMember_config_page'].'</span><br />'.
$password_message.
'<br /><br />
<table width="100%">
  <tr>
