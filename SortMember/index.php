...
case 'config':
	...
	break;
case 'memberslist':
	include($addonDir.'/memberslist.php');
	break;
case 'statslist':
	include($addonDir.'/statslist.php');
	break;
case 'debug':
	include($addonDir.'/debug.php');
	break;
case 'install_message':
	message_die($wordings[$roster_conf['roster_lang']]['SortMember_install']."<br />\n".
	...
	$wordings[$roster_conf['roster_lang']]['SortMember_install_page']);
	break;
case 'upgrade_message':
	message_die($wordings[$roster_conf['roster_lang']]['SortMember_upgrade']."<br />\n".
...
case 'cant_upgrade_message':
	message_die($wordings[$roster_conf['roster_lang']]['SortMember_no_upgrade']."<br />\n".
...
case 'uninstall_message':
	message_die($wordings[$roster_conf['roster_lang']]['SortMember_uninstall']."<br />\n".
	...
	break;
default:
	die_quietly($wordings[$roster_conf['roster_lang']]['SortMember_NoAction'],'SortMember');
}
?>
