...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td align="left"><a href="<?php echo makelink()?>?m=<?php echo $prevDay["mon"]?>&d=<?php echo $prevDay["day"]?>&y=<?php echo $prevDay["year"]?>"><img src="addons/GroupCalendar/images/calendar/leftArrow.gif" border="0"></a></td>
	...
	<td align="right"><a href="<?php echo makelink()?>?m=<?php echo $nextDay["mon"]?>&d=<?php echo $nextDay["day"]?>&y=<?php echo $nextDay["year"]?>"><img src="addons/GroupCalendar/images/calendar/rightArrow.gif" border="0"></a></td>
  </tr>
</table>
<?php if ($_GET['id']) { ?>
	...
	<tr>
	<td valign="top" width="400">
	<p class="GCH2"><img src="<?php echo  getGCimage($event['type'],"addons/GroupCalendar/images/calendar/"); ?>" border="0" style="float:right;">
	...
	<?php if (! in_array($event['type'],array("Vacation","Birth"))) { ?>
		...
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
		  ...
		  <tr class="membersRowColor2">
			...
			<th class="membersRowCell"><?php echo $roster->locale->act['Role']?></td>
		  </tr>
		  <?php
		  $stripe_counter=0;
		...
		else
		{
		  ...
		  echo'<tr '.$stripe_class.'>
			...
			<td class="membersRowCell">'.$y_attendes['role'].'</td>
		  </tr>
		  ';
		  }
		  ?>
		...
		$class_cd = '';
		  ...
		  echo'<tr '.$stripe_class.'>
			...
			<td class="membersRowCell">'.$s_attendes['role'].'</td>
		  </tr>
		  ';
		  }
		  ?>
		...
		$class_cd = '';
		  ...
		  echo'<tr '.$stripe_class.'>
			...
			<td class="membersRowCell">'.$n_attendes['role'].'</td>
		  </tr>
		  ';
		  }
		  ?>
	...
	<?php if (count($dayEvents) > 0) { ?>
		<?php print border('syellow','start',$roster->locale->act['Other_Events_Today']); ?>
			...
			<?php for ($i=0;$i<count($dayEvents);$i++) { ?>
			  <tr>
				<td valign="top"><a href="<?php echo makelink()?>&id=<?php echo $dayEvents[$i]['id']?><?php echo $sid?>"><img src="<?php echo  getGCimage($dayEvents[$i]['type'],"addons/GroupCalendar/images/calendar/"); ?>" border="0" height="40" width="40"></a></td>
