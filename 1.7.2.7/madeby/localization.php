...
* -----------------------------
*
* $Id: localization.php 18 2006-12-27 06:24:38Z zanix $
*
******************************/
define('MADEBY_VERSION', 'MadeBy v1.7.2.7');
...
// v1.7.2.7 only define if NOT using roster v1.7.3 (temp will be replaced in MadeBy v1.7.3)
if (ROSTER_VERSION !== '1.7.3')
...
// v1.7.2.7 only define if NOT using roster v1.7.3 (temp will be replaced in MadeBy v1.7.3)
if (ROSTER_VERSION !== '1.7.3')
	$wordings['esES']['Jewelcrafting'] = 'JoyerÃ­a';
