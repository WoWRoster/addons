...
* -----------------------------
*
* $Id: index.php 18 2006-12-27 06:24:38Z zanix $
*
******************************/
...
switch ($action) {
	...
	case 'install_message':
		message_die('&nbsp;&nbsp;'.$wordings[$roster_conf['roster_lang']]['MadeBy_install_msg'].'&nbsp;&nbsp;'.'<br /><br /><div style="text-align:center;"><span style="border:1px outset white; padding:2px 6px 2px 6px;"><a href="?roster_addon_name='.$_GET['roster_addon_name'].'&amp;action=install">Install</a></span></div><br />',
	...
	case 'cant_upgrade_message':
		...
		'<div style="text-align:center;"><span style="border:1px outset white; padding:2px 6px 2px 6px;"><a href="?roster_addon_name='.$_GET['roster_addon_name'].'&amp;action=install">Reinstall</a></span></div><br />',
		$wordings[$roster_conf['roster_lang']]['MadeBy_install_header']);
		break;
	default:
